...
def print_products(cursor):
    ...
    inventory_date as Stocked, TIMESTAMPDIFF(YEAR, inventory_date, CURDATE()) as 'Age in Years', product_quantity as Quantity
    FROM products
    ...
    for product in report_inventory:
        print("ID: {}\nProduct: {}\nManufacturer: {}\nStocked: {}\nQuantity: {}\nAge in Years: {}\n".format(product[0], product[1], product[2], product[3], product[5], product[4]))
...
print("{:<25s}As of {:<12s}".format(report_title, report_run_date.strftime("%m/%d/%Y")))
